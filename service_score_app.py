...
# Инструкция
with st.expander("📖 Как пользоваться системой", expanded=False):
    st.markdown("""
    ### Быстрый старт
    
    **1. Добавление выезда** (вкладка "➕ Новый отчёт"):
    - Выберите компанию из списка
    - Укажите количество выездов в месяц (K) — это план по договору
    - Введите количество проверенных станций на текущем выезде
    - Нажмите "✅ Сохранить выезд"
    
    **2. Просмотр и редактирование** (вкладка "📋 Журнал отчётов"):
    - Раскройте нужную компанию, нажав на неё
    - Увидите детальный расчёт с баллами за каждый выезд
    - Можете изменить данные любого выезда
    - Удалить отдельный выезд кнопкой 🗑️
    - Или удалить весь отчёт месяца
    
    ### Как работают баллы
    
    **Система оценивает каждый выезд по шкале 0-2 балла:**
    - **2 балла** — 90%+ от плана выезда или общий план выполнен
    - **1 балл** — 50-90% от плана выезда
    - **0 баллов** — менее 50% от плана
    
    **План на выезд (P)** = Оставшиеся станции / Оставшиеся выезды
    
    ### Пример расчёта
    
    Компания: 100 станций, 4 выезда в месяц
    - **Выезд 1:** P=25, Проверено 20 → 80% → 1 балл
    - **Выезд 2:** P=26.7, Проверено 30 → 112% → 2 балла  
    - **Выезд 3:** P=25, Проверено 25 → 100% → 2 балла
    - **Выезд 4:** P=25, Проверено 25 → 100% → 2 балла
    
    **Итого:** 7 из 8 баллов, выполнено 100%
    
    ---
    
    💡 **Совет:** Данные компаний автоматически обновляются из Google Sheets каждые 5 минут
    """)
